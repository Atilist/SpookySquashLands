...
public class LazyLeavesTemplate extends LazyBlockTemplate {
    protected int[] decayRegion;
    protected Block logBlock;
    protected Block saplingBlock;

    public LazyLeavesTemplate(Identifier identifier, Material material, float hardness, BlockSoundGroup blockSounds) {
    ...
    public void setSaplingBlock(Block saplingBlock) {
    ...
    public int getColorMultiplier(BlockView blockView, int x, int y, int z) {
        Biome[] biomes = blockView.method_1781().getBiomesInArea(x, z, 1, 1);
        if (biomes == null) {
            return 0;
        }
        Biome biome = null;
        ...
        return biome.getLeavesColor().getColor(blockView.method_1781(), x, z);
    }
