...
public class WorldGenListener {
    ...
    public void registerBiomes(BiomeRegisterEvent event) {
        ...
        spookyBuilder.hostileEntity(SpookyScarySkeletonEntity.class, 10);
        spookyBuilder.hostileEntity(ZombieEntity.class, 10);
        spookyBuilder.hostileEntity(SpiderEntity.class, 10);
        spookyBuilder.passiveEntity(CowEntity.class, 15);
        spookyBuilder.passiveEntity(SheepEntity.class, 15);
        spookyBuilder.passiveEntity(PigEntity.class, 15);
